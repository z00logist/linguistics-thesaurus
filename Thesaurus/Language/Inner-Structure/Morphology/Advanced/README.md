...
The **Advanced** section delves into more complex and specialized topics in morphology, offering a deeper look into the intricacies of word structure and formation.

## Contents
- [Allomorph](Allomorph.md)
- [Compounding](Compounding.md)
- [Distributed Morphology](Distributed-Morphology.md)
